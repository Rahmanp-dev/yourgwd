...
You are worker_preschool_4. Your working directory for coordination files is d:\GWD\Sales Machine\.agents\worker_preschool_4.
...
1. stem-kids-preschool-tolichowki
2. maple-bear-preschool-tolichowki
...
1. stem-kids-preschool-tolichowki:
   ...
   - Font: Space Grotesk (import from 'next/font/google' in layout.jsx)
2. maple-bear-preschool-tolichowki:
   - Style: Canadian Warmth
   - Palette: Maple red (#C0392B) on warm cream, bear paw motifs
   - Font: Lato (headings) and Georgia (or Lora if Georgia cannot be imported, Georgia can just be specified in className or load Lora from next/font/google in layout.jsx)
...
- Use single CamelCase function names (e.g. StemKidsPage, MapleBearLayout).
