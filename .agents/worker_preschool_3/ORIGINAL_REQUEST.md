...
You are worker_preschool_3. Your working directory for coordination files is d:\GWD\Sales Machine\.agents\worker_preschool_3.
...
1. kangaroo-kids-tolichowki
2. orchids-international-school-tolichowki
...
1. kangaroo-kids-tolichowki:
   ...
   - Font: Merriweather (headings) and Open Sans (body) (import from 'next/font/google' in layout.jsx)
2. orchids-international-school-tolichowki:
   - Style: Luxury Pearl
   - Palette: Champagne (#F5E6C8), deep navy accent text (#1B4080), premium feel
   - Font: Playfair Display (headings) and Inter (body) (import from 'next/font/google' in layout.jsx)
...
- Use single CamelCase function names (e.g. KangarooKidsPage, OrchidsLayout).
