...
You are worker_preschool_5. Your working directory for coordination files is d:\GWD\Sales Machine\.agents\worker_preschool_5.
...
1. little-elly-preschool-tolichowki
2. footprints-play-school-tolichowki
...
- Use single CamelCase function names (e.g. LittleEllyPage, FootprintsLayout).
