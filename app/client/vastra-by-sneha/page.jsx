...
export default function vastrabysnehaPage() {
  ...
  return (
    <div className="min-h-screen bg-fuchsia-50 text-fuchsia-950 font-sans">
      {/* Navigation */}
      <nav className="fixed top-0 w-full z-50 transition-all duration-300 bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20 items-center">
            <div className="flex-shrink-0 flex items-center">
              <span className="text-2xl font-sans font-bold text-fuchsia-600 font-bold">Vastra by Sneha</span>
            </div>
            <div className="hidden md:flex space-x-8 items-center">
              <a href="#collections" className="hover:text-fuchsia-600 transition-colors">Collections</a>
              <a href="#shop" className="hover:text-fuchsia-600 transition-colors">Shop</a>
              <a href="#about" className="hover:text-fuchsia-600 transition-colors">Our Story</a>
              <div className="relative cursor-pointer">
                <ShoppingBag className="w-6 h-6 hover:text-fuchsia-600 transition-colors" />
                {cartCount > 0 && (
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-1/2 space-y-8">
            <div className="inline-block px-4 py-2 rounded-full bg-white/60 backdrop-blur-sm border border-text-fuchsia-600/20 text-sm font-medium text-fuchsia-600">
              New Festive Collection 2026
            </div>
            <h1 className="text-5xl lg:text-7xl font-bold font-sans font-bold leading-tight">
              Elegance Woven in Every <span className="text-fuchsia-600 italic">Thread</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="#shop" className="inline-flex items-center justify-center px-8 py-4 rounded-full bg-fuchsia-600 hover:bg-fuchsia-700 text-white font-medium transition-all transform hover:scale-105">
                Shop the Collection
                <ArrowRight className="ml-2 w-5 h-5" />
              </a>
              <a href="https://wa.me/919876543214" target="_blank" rel="noreferrer" className="inline-flex items-center justify-center px-8 py-4 rounded-full bg-white text-emerald-600 border border-emerald-200 hover:bg-emerald-50 font-medium transition-all">
          ...
          <div className="lg:w-1/2 relative">
            <div className="absolute inset-0 bg-gradient-to-tr from-text-fuchsia-600/20 to-transparent rounded-[2rem] transform translate-x-4 translate-y-4"></div>
            <img src="https://images.unsplash.com/photo-1583391733958-6c68205f2571?q=80&w=1200&auto=format&fit=crop" alt="Hero Collection" className="relative rounded-[2rem] object-cover h-[600px] w-full shadow-2xl" />
          </div>
        </div>
      </section>
      ...
      <section id="collections" className="py-24 bg-white/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold font-sans font-bold mb-4">The Lookbook</h2>
            ...
            {['Wedding Edit', 'Everyday Elegance', 'Festive Specials'].map((title, i) => (
              <div key={i} className="group relative overflow-hidden rounded-2xl cursor-pointer aspect-[3/4]">
                ...
                <div className="absolute bottom-0 left-0 p-8 w-full">
                  <h3 className="text-2xl text-white font-sans font-bold font-medium mb-2">{title}</h3>
      ...
      <section id="shop" className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-end mb-12">
          <div>
            <h2 className="text-4xl font-bold font-sans font-bold mb-4">Latest Arrivals</h2>
            <p className="opacity-80">Shop our most coveted pieces.</p>
          </div>
          <button className="text-fuchsia-600 font-medium hover:underline flex items-center">
            View All <ArrowRight className="ml-1 w-4 h-4" />
          </button>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {products.map((product) => (
            <div key={product.id} className="group flex flex-col bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow duration-300 ">
              <div className="relative aspect-[4/5] overflow-hidden bg-gray-100">
                ...
                <div className="absolute bottom-0 left-0 w-full p-4 transform translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                  <button onClick={addToCart} className="w-full py-3 bg-fuchsia-600 hover:bg-fuchsia-700 text-white font-medium rounded-xl shadow-lg flex items-center justify-center gap-2">
              ...
              <div className="p-6">
                ...
                <p className="text-fuchsia-600 font-semibold text-lg">{product.price}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-black/10">
            <div className="flex flex-col items-center p-6">
              <div className="w-16 h-16 rounded-full bg-text-fuchsia-600/10 flex items-center justify-center mb-4">
                <Shield className="w-8 h-8 text-fuchsia-600" />
              </div>
              <h3 className="text-xl font-medium font-sans font-bold mb-2">Secure Payments</h3>
              <p className="opacity-70 text-sm">100% secure transactions via UPI, Credit/Debit cards.</p>
            </div>
            <div className="flex flex-col items-center p-6">
              <div className="w-16 h-16 rounded-full bg-text-fuchsia-600/10 flex items-center justify-center mb-4">
                <Truck className="w-8 h-8 text-fuchsia-600" />
              </div>
              <h3 className="text-xl font-medium font-sans font-bold mb-2">Pan-India Shipping</h3>
              <p className="opacity-70 text-sm">Fast and reliable delivery across all Indian pin codes.</p>
            </div>
            <div className="flex flex-col items-center p-6">
              <div className="w-16 h-16 rounded-full bg-text-fuchsia-600/10 flex items-center justify-center mb-4">
                <Info className="w-8 h-8 text-fuchsia-600" />
              </div>
              <h3 className="text-xl font-medium font-sans font-bold mb-2">Custom Tailoring</h3>
      ...
      <section id="about" className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
          <div className="lg:w-1/2 space-y-6">
            <h2 className="text-4xl font-bold font-sans font-bold">The Story of Vastra by Sneha</h2>
      ...
      {/* 6. Testimonials */}
      <section className="py-24 bg-text-fuchsia-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold font-sans font-bold mb-4">Loved by Women in Cyberabad</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            <div className="col-span-1 md:col-span-2">
              <span className="text-3xl font-sans font-bold font-bold mb-6 block">Vastra by Sneha</span>
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-text-fuchsia-600 transition-colors">
                  <Instagram className="w-5 h-5" />
                </a>
                <a href="https://wa.me/919876543214" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-emerald-500 transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-4 text-gray-400">
                ...
                <li>Email: hello@vastrabysneha.com</li>
                <li>WhatsApp: +919876543214</li>
              </ul>
            </div>
          </div>
          <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
            <p>&copy; 2026 Vastra by Sneha. All rights reserved.</p>
