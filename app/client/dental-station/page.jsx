    ...
    <div style={{ fontFamily: 'system-ui, sans-serif', color: '#1e293b', background: '#ffffff', minHeight: '100vh', overflowX: 'hidden' }}>
      ...
      <header style={{ background: 'linear-gradient(135deg, #fafafa 0%, #ffffff 100%)', padding: '100px 8%', display: 'flex', alignItems: 'center', gap: '40px', flexWrap: 'wrap' }}>
        <div style={{ flex: '1 1 500px' }}>
          <div style={{ display: 'inline-block', background: '#e0f2fe', color: '#0f172a', padding: '6px 16px', borderRadius: '100px', fontSize: '0.85rem', fontWeight: 800, marginBottom: '24px' }}>
            Orthodontics & Implants • Tolichowki
          </div>
          <h1 style={{ fontSize: '3.6rem', fontWeight: 900, color: '#0f172a', lineHeight: 1.15, marginBottom: '24px', letterSpacing: '-1.5px' }}>
            Precision Orthodontics & <span style={{ color: '#0284c7' }}>Dental Implants</span>
          </h1>
          <p style={{ fontSize: '1.25rem', color: '#4b5563', lineHeight: 1.6, marginBottom: '40px', maxWidth: '600px' }}>
            Tolichowki’s cutting-edge dental center. Specializing in clear aligners, pain-free implants, and modern maxillofacial care.
          </p>
        ...
        <div style={{ flex: '1 1 400px', display: 'flex', justifyContent: 'center' }}>
          <div style={{ width: '380px', height: '380px', borderRadius: '30px', background: 'linear-gradient(135deg, #0284c7 0%, #0f172a 100%)', display: 'flex', justifyContent: 'center', alignItems: 'center', boxShadow: '0 20px 40px rgba(0,0,0,0.1)' }}>
      ...
      <section style={{ padding: '80px 8%', background: '#f9fafb' }}>
        ...
        <p style={{ color: '#6b7280', fontSize: '1.1rem', textAlign: 'center', marginBottom: '60px' }}>
          Custom tailored features designed explicitly for the medical operations of Dental Station.
        </p>

        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '30px', maxWidth: '1200px', margin: '0 auto' }}>
          {[{"name":"Clear Aligner Mockup","desc":"Book a scan to design your customized, invisible braces."},{"name":"Laser Surgery Booking","desc":"Schedule quick, minimally invasive laser procedures."},{"name":"Interactive Treatment Tracker","desc":"Track your implant or braces progression directly on your phone."}].map((feat, i) => (
            <div key={i} style={{ background: '#ffffff', padding: '36px', borderRadius: '16px', border: '1px solid #e5e7eb', boxShadow: '0 4px 10px rgba(0,0,0,0.01)' }}>
              <div style={{ width: '48px', height: '48px', borderRadius: '12px', background: '#e0f2fe', display: 'flex', justifyContent: 'center', alignItems: 'center', marginBottom: '24px' }}>
      ...
      <footer style={{ background: '#0f172a', color: '#9ca3af', padding: '60px 8%', textAlign: 'center', borderTop: '1px solid #1f2937' }}>
        <h3 style={{ color: '#fff', fontSize: '1.4rem', fontWeight: 800, marginBottom: '8px' }}>Dental Station</h3>
