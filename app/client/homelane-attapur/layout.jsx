...
export const metadata = {
  title: 'HomeLane Attapur | Smart & Pastel Glassmorphic Interior Design',
  ...
  openGraph: {
    title: 'HomeLane Attapur | Smart Home & Pastel Glassmorphic Interiors',
    ...
    siteName: 'HomeLane Attapur',
    images: [
      {
        url: 'https://images.unsplash.com/photo-1558882224-cca166733360?auto=format&fit=crop&w=1200&h=630&q=80',
        width: 1200,
        height: 630,
        alt: 'HomeLane Attapur - Modern Smart Living Room with Frosted Pastel Accents'
      }
    ],
    locale: 'en_US',
    type: 'website',
