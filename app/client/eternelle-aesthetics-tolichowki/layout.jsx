...
export const metadata = {
  title: 'Eternelle Aesthetics | Premium Dermatological Excellence Tolichowki',
  description: 'Experience elite skin, hair, and laser treatments at Eternelle Clinic, Tolichowki. Advanced USFDA-approved therapies, chemical peels, and hair restoration. Book your premium consultation.',
  openGraph: {
    title: 'Eternelle Aesthetics - Tolichowki',
    ...
    siteName: 'Eternelle Aesthetics',
    images: [
      {
        url: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&q=80&w=1200&h=630',
        width: 1200,
        height: 630,
        alt: 'Eternelle Aesthetics Consultation Room'
      }
    ]
  }
};

export default function EternelleLayout({ children }) {
  return (
