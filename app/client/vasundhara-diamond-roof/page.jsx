...
export default function Page() {
  ...
  const current = styles['dark'] || styles.glassmorphism;
  ...
  return (
    <div className={`${current.outer} min-h-screen`} style={{ minHeight: '100vh' }}>
        ...
        <div className="max-w-7xl mx-auto px-6 h-full flex justify-between items-center">
          <a href="#" className="flex items-center gap-3">
            <div className={`w-10 h-10 flex items-center justify-center font-bold text-lg rounded-lg ${current.logoBox}`}>
              {['G', 'H', 'O', 'A', 'D'].includes('V') ? 'V' : 'J'}
            </div>
            <div>
              <span className="font-extrabold text-lg tracking-tight block uppercase text-white">Vasundhara Diamond Roof</span>
              <span className="text-[9px] uppercase tracking-widest block -mt-1 opacity-70">Bespoke Diamond Bridal Sets</span>
            </div>
          </a>
      ...
      <section id="heritage" className="py-20 max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <p className="text-sm opacity-80 leading-relaxed font-light">
            For generations, Vasundhara Diamond Roof has been synonymous with the finest jewellery in Hyderabad. From selecting rare south-sea pearls at the markets to casting gold into beautiful Nakshi patterns, our master artisans craft each piece with precision.
          </p>
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="space-y-4 pt-4 border-t border-white/10">
            <div className="flex gap-3 text-xs">
              ...
              <span>Somajiguda Main Road, Hyderabad - 500082</span>
            </div>
            <div className="flex gap-3 text-xs">
              <Phone className="w-5 h-5 shrink-0 opacity-70" />
              <a href={`tel:+91${'7675898989'}`} className="hover:underline">+91 7675898989</a>
            </div>
            <div className="flex gap-3 text-xs">
              <Mail className="w-5 h-5 shrink-0 opacity-70" />
              <a href={`mailto:${'info@vasundharadiamondroof.com'}`} className="hover:underline">info@vasundharadiamondroof.com</a>
            </div>
          </div>
        </div>
      ...
      <footer className={`py-12 border-t ${current.divider} text-center text-[10px] uppercase tracking-widest opacity-60`}>
        © 2026 Vasundhara Diamond Roof Hyderabad • Secure Digital Vault • Design Studio
      </footer>
