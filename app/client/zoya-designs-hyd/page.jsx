...
export default function zoyadesignshydPage() {
    ...
    <div className="min-h-screen bg-emerald-50 text-emerald-950 font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20 items-center">
            <div className="flex-shrink-0 flex items-center">
              <span className="text-2xl font-serif text-emerald-700 font-bold">Zoya Designer Wear</span>
            </div>
            <div className="hidden md:flex space-x-8 items-center">
              ...
              <div className="relative cursor-pointer">
                <ShoppingBag className="w-6 h-6 hover:text-emerald-700 transition-colors" />
                {cartCount > 0 && (
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-1/2 space-y-8">
            <div className="inline-block px-4 py-2 rounded-full bg-white/60 backdrop-blur-sm border border-text-emerald-700/20 text-sm font-medium text-emerald-700">
              New Festive Collection 2026
            </div>
            <h1 className="text-5xl lg:text-7xl font-bold font-serif leading-tight">
              Elegance Woven in Every <span className="text-emerald-700 italic">Thread</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="#shop" className="inline-flex items-center justify-center px-8 py-4 rounded-full bg-emerald-800 hover:bg-emerald-900 text-white font-medium transition-all transform hover:scale-105">
                Shop the Collection
                <ArrowRight className="ml-2 w-5 h-5" />
              </a>
              <a href="https://wa.me/919876543211" target="_blank" rel="noreferrer" className="inline-flex items-center justify-center px-8 py-4 rounded-full bg-white text-emerald-600 border border-emerald-200 hover:bg-emerald-50 font-medium transition-all">
          ...
          <div className="lg:w-1/2 relative">
            <div className="absolute inset-0 bg-gradient-to-tr from-text-emerald-700/20 to-transparent rounded-[2rem] transform translate-x-4 translate-y-4"></div>
      ...
      <section id="shop" className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-end mb-12">
          ...
          <button className="text-emerald-700 font-medium hover:underline flex items-center">
            ...
            <div key={product.id} className="group flex flex-col bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow duration-300 ">
              <div className="relative aspect-[4/5] overflow-hidden bg-gray-100">
                ...
                <div className="absolute bottom-0 left-0 w-full p-4 transform translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                  <button onClick={addToCart} className="w-full py-3 bg-emerald-800 hover:bg-emerald-900 text-white font-medium rounded-xl shadow-lg flex items-center justify-center gap-2">
              ...
              <div className="p-6">
                ...
                <p className="text-emerald-700 font-semibold text-lg">{product.price}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-black/10">
            <div className="flex flex-col items-center p-6">
              <div className="w-16 h-16 rounded-full bg-text-emerald-700/10 flex items-center justify-center mb-4">
      ...
      <section id="about" className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
          <div className="lg:w-1/2 space-y-6">
            <h2 className="text-4xl font-bold font-serif">The Story of Zoya Designer Wear</h2>
      ...
      {/* 6. Testimonials */}
      <section className="py-24 bg-text-emerald-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            <div className="col-span-1 md:col-span-2">
              <span className="text-3xl font-serif font-bold mb-6 block">Zoya Designer Wear</span>
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-text-emerald-700 transition-colors">
                  <Instagram className="w-5 h-5" />
                </a>
                <a href="https://wa.me/919876543211" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-emerald-500 transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-4 text-gray-400">
                ...
                <li>Email: hello@zoyadesignshyd.com</li>
                <li>WhatsApp: +919876543211</li>
              </ul>
            </div>
          </div>
          <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
            <p>&copy; 2026 Zoya Designer Wear. All rights reserved.</p>
