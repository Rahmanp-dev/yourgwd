    ...
    <div className={`min-h-screen ${"bg-gray-100"} font-sans overflow-hidden`}>
      ...
      <nav className="p-6 md:px-12 flex justify-between items-center z-50 relative">
        <div className="flex items-center gap-3">
          ...
          <span className={`text-xl font-bold ${"text-gray-800"}`}>RK Property Consultants</span>
        </div>
        <button className={`px-6 py-2.5 rounded-lg font-semibold ${"bg-violet-500 text-white shadow-[inset_2px_2px_5px_rgba(255,255,255,0.3),_5px_5px_15px_rgba(0,0,0,0.1)] hover:shadow-[inset_2px_2px_5px_rgba(0,0,0,0.3)] transition-all"}`}>
          Client Portal Login
        </button>
      </nav>
      ...
      <main className="px-6 md:px-12 py-16 md:py-32 max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center relative z-10">
        <div className="space-y-8">
          <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-bold ${"bg-gray-100 rounded-[30px] shadow-[20px_20px_60px_#bebebe,-20px_-20px_60px_#ffffff]"} ${"text-violet-600"}`}>
          ...
          <h1 className={`text-5xl md:text-7xl leading-tight ${"text-gray-800"}`}>
            ...
            <span className={`${"text-violet-600"}`}>Digitized.</span>
          </h1>
          <p className={`text-lg md:text-xl max-w-lg opacity-80 ${"text-gray-800"}`}>
            Welcome to the new digital home of RK Property Consultants. We've integrated VR tours, smart CRM, and advanced listing management directly into your operations.
          </p>
          <div className="flex gap-4">
            <button className={`px-8 py-4 rounded-xl font-bold flex items-center gap-2 ${"bg-violet-500 text-white shadow-[inset_2px_2px_5px_rgba(255,255,255,0.3),_5px_5px_15px_rgba(0,0,0,0.1)] hover:shadow-[inset_2px_2px_5px_rgba(0,0,0,0.3)] transition-all"}`}>
