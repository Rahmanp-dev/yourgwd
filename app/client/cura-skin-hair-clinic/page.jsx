...
export default function CuraSkinClinicPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FFF0EE] text-[#2A1A1C] selection:bg-[#4A90E2]/20 font-sans antialiased relative overflow-hidden">
      
      {/* Background Ambient Glow Elements */}
      <div className="absolute top-[10%] left-[-10%] w-[350px] h-[350px] rounded-full bg-[#4A90E2]/8 blur-[90px] pointer-events-none"></div>
      <div className="absolute top-[40%] right-[-10%] w-[450px] h-[450px] rounded-full bg-[#FFFDFD]/40 blur-[100px] pointer-events-none"></div>
      <div className="absolute bottom-[20%] left-[5%] w-[400px] h-[400px] rounded-full bg-[#4A90E2]/6 blur-[110px] pointer-events-none"></div>

      {/* Header / Navigation */}
      <header className="sticky top-0 z-50 w-full backdrop-blur-md bg-[#FFF0EE]/80 border-b border-[#4A90E2]/15">
        <div className="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center">
          <div className="flex flex-col">
            <span className="font-serif text-2xl font-bold tracking-wide text-[#4A90E2]">
              Cura Skin
            </span>
          ...
          <nav className="hidden md:flex items-center space-x-8 text-sm font-medium">
            <a href="#expertise" className="hover:text-[#4A90E2] transition-colors">Expertise</a>
            <a href="#estimator" className="hover:text-[#4A90E2] transition-colors">Price Estimator</a>
            <a href="#services" className="hover:text-[#4A90E2] transition-colors">Services</a>
            <a href="#testimonials" className="hover:text-[#4A90E2] transition-colors">Transformations</a>
            <a href="#booking-form" className="px-5 py-2.5 rounded-full border border-[#4A90E2] text-[#4A90E2] hover:bg-[#4A90E2] hover:text-white transition-all text-xs uppercase tracking-wider font-semibold active:scale-95">
              Book Appointment
            </a>
          </nav>
          ...
          <button 
            ...
            className="md:hidden p-2 text-slate-600 hover:text-[#4A90E2] transition-colors"
          >
        ...
        {mobileMenuOpen && (
          <div className="md:hidden w-full bg-[#FFF0EE]/95 border-b border-[#4A90E2]/10 backdrop-blur-lg px-6 py-6 absolute top-20 left-0 flex flex-col space-y-4 animate-fadeIn">
            <a href="#expertise" onClick={() => setMobileMenuOpen(false)} className="text-base font-medium text-slate-800 hover:text-[#4A90E2]">Expertise</a>
            <a href="#estimator" onClick={() => setMobileMenuOpen(false)} className="text-base font-medium text-slate-800 hover:text-[#4A90E2]">Price Estimator</a>
            <a href="#services" onClick={() => setMobileMenuOpen(false)} className="text-base font-medium text-slate-800 hover:text-[#4A90E2]">Services</a>
            <a href="#testimonials" onClick={() => setMobileMenuOpen(false)} className="text-base font-medium text-slate-800 hover:text-[#4A90E2]">Transformations</a>
            <a 
              href="#booking-form" 
              onClick={() => setMobileMenuOpen(false)}
              className="w-full text-center py-3 rounded-full bg-[#4A90E2] text-white font-semibold uppercase text-xs tracking-wider"
            >
              Book Consultation
            </a>
          </div>
      ...
      <section className="relative pt-12 pb-24 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-7 flex flex-col space-y-6">
          <div className="inline-flex items-center space-x-2 bg-[#FFFDFD]/80 border border-[#4A90E2]/20 px-4 py-1.5 rounded-full text-xs font-semibold tracking-wider text-[#4A90E2] w-fit shadow-sm">
            <Sparkles size={14} />
          ...
          <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl text-slate-900 leading-tight font-extrabold">
            ...
            <span className="text-[#4A90E2] relative inline-block">
              Skin & Healthy Hair
              <span className="absolute bottom-1 left-0 w-full h-1 bg-[#4A90E2]/20 rounded"></span>
            </span>
          </h1>

          <p className="text-slate-600 text-base sm:text-lg max-w-2xl leading-relaxed">
            Welcome to Cura Skin, Hair & Laser Clinic in Tolichowki. Guided by premium medical standards and USFDA-approved technologies, we craft customized treatment regimes for acne, pigmentation, hair fall, and aging.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <a 
              href="#booking-form" 
              className="px-8 py-4 bg-[#4A90E2] text-white rounded-full font-semibold shadow-lg shadow-[#4A90E2]/20 hover:bg-[#A35D68] transition-all hover:-translate-y-0.5 active:translate-y-0 text-center flex items-center justify-center space-x-2"
            >
            ...
            <a 
              href="#estimator" 
              className="px-8 py-4 bg-[#FFFDFD]/70 hover:bg-[#FFFDFD] text-slate-800 rounded-full font-semibold border border-[#4A90E2]/30 transition-all text-center flex items-center justify-center space-x-2"
            >
          ...
          {/* Quick Metrics */}
          <div className="grid grid-cols-3 gap-4 pt-8 border-t border-[#4A90E2]/15">
            <div>
        ...
        <div className="lg:col-span-5 relative flex justify-center">
          <div className="relative w-full max-w-[420px] aspect-[4/5] rounded-[32px] p-4 bg-[#FFFDFD]/60 backdrop-blur-md border border-[#4A90E2]/25 shadow-xl">
            <div className="w-full h-full rounded-[24px] overflow-hidden relative group">
              ...
              <div className="absolute bottom-6 left-6 right-6 p-4 rounded-2xl bg-[#FFFDFD]/90 backdrop-blur-md border border-[#4A90E2]/20 shadow-lg">
                <div className="flex items-center space-x-3">
                  <div className="bg-[#FFF0EE] p-2 rounded-lg text-[#4A90E2]">
                    <ShieldCheck size={20} />
                  </div>
                  <div>
      ...
      <section id="expertise" className="py-20 bg-[#FFFDFD]/60 backdrop-blur-md border-y border-[#4A90E2]/15">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <h2 className="font-serif text-3xl sm:text-4xl font-bold text-slate-900">
              Why Tolichowki Trusts Cura Skin Clinic
            </h2>
            <div className="w-16 h-1 bg-[#4A90E2] mx-auto rounded"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              {
                icon: <ShieldCheck className="w-8 h-8 text-[#4A90E2]" />,
              ...
              <div 
                key={idx} 
                className="p-8 rounded-2xl bg-[#FFFDFD]/80 border border-[#4A90E2]/15 shadow-sm hover:border-[#4A90E2]/35 hover:shadow-md transition-all duration-300 flex flex-col space-y-4"
              >
      ...
      <section id="estimator" className="py-20 px-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="inline-flex items-center space-x-1 bg-[#FFFDFD]/80 border border-[#4A90E2]/20 px-3 py-1 rounded-full text-xs font-semibold text-[#4A90E2] w-fit shadow-xs">
              <span>TRANSPARENT PRICING</span>
            </div>
            
            <h2 className="font-serif text-3xl sm:text-4xl font-bold text-slate-900 leading-tight">
              Interactive <br />
              <span className="text-[#4A90E2]">Treatment Estimator</span>
            </h2>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <div className="bg-[#4A90E2]/10 p-1 rounded mt-1 text-[#4A90E2]">
                  <Check size={14} />
                </div>
          ...
          <div className="lg:col-span-7 bg-[#FFFDFD]/75 backdrop-blur-md border border-[#4A90E2]/20 p-6 sm:p-8 rounded-3xl shadow-lg relative">
            <div className="absolute top-4 right-4 text-[#4A90E2]/20">
              <Info size={40} />
            </div>
            ...
            <div className="space-y-6">
                    ...
                    return (
                      <button
                        ...
                        className={`p-4 rounded-xl text-left border transition-all flex items-center space-x-3 ${
                          selectedTx === tx.id 
                            ? 'bg-[#4A90E2]/10 border-[#4A90E2] shadow-xs' 
                            : 'bg-[#FFFDFD] border-slate-200 hover:border-[#4A90E2]/40'
                        }`}
                      >
                        <div className={`p-2 rounded-lg ${selectedTx === tx.id ? 'bg-[#4A90E2] text-white' : 'bg-[#FFF0EE] text-[#4A90E2]'}`}>
                    ...
                    <button
                      ...
                      className={`px-4 py-2.5 rounded-full text-xs font-bold transition-all border ${
                        selectedArea === area.id
                          ...
                          : 'bg-[#FFFDFD] border-slate-200 text-slate-600 hover:border-[#4A90E2]/45'
                      }`}
                    >
              ...
              <div>
                <div className="flex justify-between items-center mb-3">
                  ...
                  <span className="text-sm font-bold text-[#4A90E2] bg-[#4A90E2]/10 px-3 py-1 rounded-full">
                ...
                <input 
                  ...
                  className="w-full accent-[#4A90E2] h-1.5 bg-slate-200 rounded-lg appearance-none cursor-pointer"
                />
              ...
              {/* Output Billing Grid */}
              <div className="p-5 rounded-2xl bg-[#FFF0EE]/50 border border-[#4A90E2]/15 space-y-3">
                ...
                <div className="h-[1px] bg-[#4A90E2]/20 my-2"></div>
      ...
      {/* Services Grid */}
      <section id="services" className="py-20 bg-[#FFFDFD]/40 backdrop-blur-md border-t border-[#4A90E2]/15">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <span className="text-xs font-bold text-[#4A90E2] uppercase tracking-widest block">Signature Offerings</span>
            <h2 className="font-serif text-3xl sm:text-4xl font-bold text-slate-900">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div 
                key={idx} 
                className="bg-[#FFFDFD]/80 border border-[#4A90E2]/15 p-6 rounded-2xl shadow-xs hover:border-[#4A90E2]/35 hover:shadow-md hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between"
              >
                <div className="space-y-4">
      ...
      <section id="testimonials" className="py-20 max-w-7xl mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <span className="text-xs font-bold text-[#4A90E2] uppercase tracking-widest block">Proven Outcomes</span>
          <h2 className="font-serif text-3xl sm:text-4xl font-bold text-slate-900">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          {/* Transformation 1 */}
          <div className="bg-[#FFFDFD]/80 border border-[#4A90E2]/20 p-6 rounded-3xl shadow-sm space-y-6">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="relative rounded-2xl overflow-hidden aspect-[4/3] bg-slate-100">
                ...
                />
                <span className="absolute top-3 left-3 px-2 py-1 bg-[#4A90E2]/80 text-[10px] font-bold text-white uppercase tracking-wider rounded">After 6 Weeks</span>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm italic text-slate-700 leading-relaxed">
                "I suffered from grade-3 cystic acne for almost 3 years. The salicylic peels and localized blue-light therapies recommended by Cura Skin cleared my skin completely in just 6 sessions. Exceptional care!"
              </p>
          ...
          <div className="bg-[#FFFDFD]/80 border border-[#4A90E2]/20 p-6 rounded-3xl shadow-sm space-y-6">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="relative rounded-2xl overflow-hidden aspect-[4/3] bg-slate-100">
                <img 
                  ...
                  className="w-full h-full object-cover"
                />
                <span className="absolute top-3 left-3 px-2 py-1 bg-[#4A90E2]/80 text-[10px] font-bold text-white uppercase tracking-wider rounded">After 4 Sessions</span>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm italic text-slate-700 leading-relaxed">
                "My hairline was receding rapidly. The PRP therapy combined with custom nutritional supplements triggered massive new hair growth. The density has improved dramatically. Highly recommend Cura Skin!"
              </p>
              <div className="text-xs font-bold text-slate-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div key={idx} className="p-6 rounded-xl bg-[#FFFDFD]/60 border border-[#4A90E2]/15 shadow-xs space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-xs font-bold text-slate-800">{t.name}</span>
                <span className="text-[10px] text-[#4A90E2] bg-[#4A90E2]/10 px-2 py-0.5 rounded-full font-medium">{t.tx}</span>
              </div>
      ...
      <section id="booking-form" className="py-20 bg-[#FFFDFD]/60 backdrop-blur-md border-t border-[#4A90E2]/15 px-6">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12 space-y-3">
            <span className="text-xs font-bold text-[#4A90E2] uppercase tracking-widest block">Direct Slot Reservation</span>
          ...
          {/* Form Card */}
          <div className="bg-[#FFFDFD] border border-[#4A90E2]/20 p-8 rounded-3xl shadow-md">
            ...
            {submittedData ? (
              ...
              <div className="text-center py-8 space-y-6 animate-scaleUp">
                ...
                <div className="p-6 rounded-2xl bg-[#FFF0EE]/40 border border-[#4A90E2]/15 text-left max-w-md mx-auto space-y-3 text-xs">
                ...
                <p className="text-xs text-slate-500 max-w-sm mx-auto leading-relaxed">
                  Our doctor will review your details. For urgent alterations, call us directly at <span className="font-bold text-[#4A90E2]">9849555123</span>.
                </p>
              ...
              <form onSubmit={handleBookingSubmit} className="space-y-6">
                ...
                {estimateLocked && (
                  <div className="p-4 rounded-xl bg-[#4A90E2]/10 border border-[#4A90E2]/30 flex items-start space-x-3 text-xs text-[#4A90E2]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      className={`w-full px-4 py-3 rounded-xl border bg-white focus:outline-none transition-all ${
                        errors.name ? 'border-red-400 focus:ring-1 focus:ring-red-300' : 'border-slate-200 focus:border-[#4A90E2] focus:ring-1 focus:ring-[#4A90E2]'
                      }`}
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      className={`w-full px-4 py-3 rounded-xl border bg-white focus:outline-none transition-all ${
                        errors.phone ? 'border-red-400 focus:ring-1 focus:ring-red-300' : 'border-slate-200 focus:border-[#4A90E2] focus:ring-1 focus:ring-[#4A90E2]'
                      }`}
                    />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      className={`w-full px-4 py-3 rounded-xl border bg-white focus:outline-none transition-all ${
                        errors.email ? 'border-red-400 focus:ring-1 focus:ring-red-300' : 'border-slate-200 focus:border-[#4A90E2] focus:ring-1 focus:ring-[#4A90E2]'
                      }`}
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-4 py-3 rounded-xl border bg-white focus:outline-none transition-all ${
                        errors.date ? 'border-red-400 focus:ring-1 focus:ring-red-300' : 'border-slate-200 focus:border-[#4A90E2] focus:ring-1 focus:ring-[#4A90E2]'
                      }`}
                    />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      value={form.time}
                      onChange={handleInputChange}
                      className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-white focus:border-[#4A90E2] focus:ring-1 focus:ring-[#4A90E2] focus:outline-none text-sm text-slate-700"
                    >
                  ...
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-white focus:border-[#4A90E2] focus:ring-1 focus:ring-[#4A90E2] focus:outline-none text-sm"
                    />
                  </div>
                </div>
                ...
                <button
                  ...
                  className="w-full py-4 rounded-xl bg-[#4A90E2] text-white font-bold text-sm tracking-wider uppercase hover:bg-[#A35D68] transition-all flex items-center justify-center space-x-2 shadow-md shadow-[#4A90E2]/20 disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
                    <>
      ...
      <footer className="bg-slate-900 text-slate-400 py-16 px-6 border-t border-[#4A90E2]/20">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12">
          
          <div className="md:col-span-5 space-y-6">
            <div>
              <span className="font-serif text-2xl font-bold tracking-wide text-[#4A90E2] block">
                Cura Skin, Hair & Laser Clinic
              </span>
            ...
            <div className="flex space-x-4 text-xs font-semibold text-slate-300">
              <span className="flex items-center space-x-1 text-[#4A90E2]">
                <ShieldCheck size={14} />
          ...
          <div className="md:col-span-4 space-y-4">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start space-x-2.5">
                <MapPin size={18} className="text-[#4A90E2] shrink-0 mt-0.5" />
              ...
              <div className="flex items-center space-x-2.5">
                <Phone size={16} className="text-[#4A90E2] shrink-0" />
                <span className="text-slate-300 font-bold">9849555123</span>
              </div>
              <div className="flex items-center space-x-2.5">
                <Mail size={16} className="text-[#4A90E2] shrink-0" />
        ...
        <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-slate-800 text-center text-[10px] text-slate-600">
          <p>© 2026 Cura Skin, Hair & Laser Clinic. All rights reserved. Developed under GWD Premium Design Standards.</p>
        </div>
      </footer>
