...
export const metadata = {
  title: 'Clear Skin Centre | Premium Dermatological Excellence Tolichowki',
  description: 'Experience elite skin, hair, and laser treatments at Clear Skin Clinic, Tolichowki. Advanced USFDA-approved therapies, chemical peels, and hair restoration. Book your premium consultation.',
  openGraph: {
    title: 'Clear Skin Centre - Tolichowki',
    ...
    siteName: 'Clear Skin Centre',
    images: [
      {
        url: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&q=80&w=1200&h=630',
        width: 1200,
        height: 630,
        alt: 'Clear Skin Centre Consultation Room'
      }
    ]
  }
};

export default function ClearSkinLayout({ children }) {
  return (
