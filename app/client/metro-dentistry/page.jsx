...
export default function ClientPage() {
  ...
  const iconMap = {
    Heart: <Heart size={36} color="#0d9488" />,
    Activity: <Activity size={36} color="#0d9488" />,
    Users: <Users size={36} color="#0d9488" />,
    Zap: <Zap size={36} color="#0d9488" />,
    Leaf: <Leaf size={36} color="#0d9488" />,
    FileText: <FileText size={36} color="#0d9488" />
  };
    ...
    <div style={{ fontFamily: 'system-ui, sans-serif', color: '#0f172a', background: '#ffffff', minHeight: '100vh', overflowX: 'hidden' }}>
      ...
      <nav style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '20px 8%', borderBottom: '1px solid #f1f5f9' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '1.45rem', fontWeight: 900, color: '#0f172a' }}>
          <div style={{ width: '44px', height: '44px', background: '#f0fdfa', borderRadius: '12px', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            {iconMap['Zap'] || <Activity size={36} />}
          </div>
          Metro Dentistry
        </div>
        <div>
          <button style={{ background: '#0d9488', color: '#fff', border: 'none', padding: '10px 24px', borderRadius: '8px', fontWeight: 700, cursor: 'pointer' }}>
      ...
      <header style={{ background: 'linear-gradient(135deg, #f0fdfa 0%, #ffffff 100%)', padding: '100px 8%', display: 'flex', alignItems: 'center', gap: '40px', flexWrap: 'wrap' }}>
        <div style={{ flex: '1 1 500px' }}>
          <div style={{ display: 'inline-block', background: '#ccfbf1', color: '#0f766e', padding: '6px 16px', borderRadius: '100px', fontSize: '0.85rem', fontWeight: 800, marginBottom: '24px' }}>
            Dental Clinic • Tolichowki
          </div>
          <h1 style={{ fontSize: '3.6rem', fontWeight: 900, color: '#0f172a', lineHeight: 1.15, marginBottom: '24px', letterSpacing: '-1.5px' }}>
            Bespoke Cosmetic Dentistry <span style={{ color: '#0d9488' }}>& Smile Design</span>
          </h1>
          <p style={{ fontSize: '1.25rem', color: '#4b5563', lineHeight: 1.6, marginBottom: '40px', maxWidth: '600px' }}>
            Located at Brindavan Colony, Metro Dentistry specializes in smile corrections, modern root canals, and premium dental implants.
          </p>
          ...
          {submitted ? (
            ...
            <form onSubmit={handleBook} style={{ background: '#ffffff', padding: '30px', borderRadius: '20px', border: '1px solid #e5e7eb', boxShadow: '0 10px 30px rgba(0,0,0,0.04)', display: 'flex', flexDirection: 'column', gap: '16px', maxWidth: '500px' }}>
              ...
              <button type="submit" style={{ width: '100%', padding: '16px', background: '#0d9488', color: '#fff', borderRadius: '8px', border: 'none', fontWeight: 700, fontSize: '1.1rem', cursor: 'pointer', boxShadow: '0 4px 12px rgba(0,0,0,0.05)' }}>
                Schedule Smile Consultation
              </button>
            </form>
          )}
        ...
        <div style={{ flex: '1 1 400px', display: 'flex', justifyContent: 'center' }}>
          <div style={{ width: '380px', height: '380px', borderRadius: '30px', background: 'linear-gradient(135deg, #0d9488 0%, #0f766e 100%)', display: 'flex', justifyContent: 'center', alignItems: 'center', boxShadow: '0 20px 40px rgba(0,0,0,0.1)' }}>
      ...
      <section style={{ padding: '80px 8%', background: '#f9fafb' }}>
        <h2 style={{ fontSize: '2.2rem', fontWeight: 800, color: '#0f172a', marginBottom: '16px', textAlign: 'center' }}>
          Interactive Smile Design
        </h2>
        <p style={{ color: '#6b7280', fontSize: '1.1rem', textAlign: 'center', marginBottom: '60px' }}>
          Custom tailored features designed explicitly for the medical operations of Metro Dentistry.
        </p>

        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '30px', maxWidth: '1200px', margin: '0 auto' }}>
          {[{"name":"3D Smile Consultation","desc":"Book a digital evaluation to preview your orthodontic outcome."},{"name":"Flexible Appointment Scheduler","desc":"Book dental cleanings and procedures on your mobile in under 60 seconds."},{"name":"Digital Before/After Gallery","desc":"Explore verified success cases and smile makeovers from Dr. Kamran."}].map((feat, i) => (
            <div key={i} style={{ background: '#ffffff', padding: '36px', borderRadius: '16px', border: '1px solid #e5e7eb', boxShadow: '0 4px 10px rgba(0,0,0,0.01)' }}>
              <div style={{ width: '48px', height: '48px', borderRadius: '12px', background: '#ccfbf1', display: 'flex', justifyContent: 'center', alignItems: 'center', marginBottom: '24px' }}>
      ...
      <footer style={{ background: '#0f172a', color: '#9ca3af', padding: '60px 8%', textAlign: 'center', borderTop: '1px solid #1f2937' }}>
        <h3 style={{ color: '#fff', fontSize: '1.4rem', fontWeight: 800, marginBottom: '8px' }}>Metro Dentistry</h3>
